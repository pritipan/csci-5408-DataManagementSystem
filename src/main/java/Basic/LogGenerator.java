...
public class LogGenerator {
    ...
    public static void logQueryExecute(String query, String message){
        File file = new File("src/main/java/FileStorage/QueryLogs.txt");
    ...
    public static void logEventExecute(String query, String message){
        File file = new File("src/main/java/FileStorage/EventLogs.txt");
        PrintWriter printWriter;
        try {
            SimpleDateFormat formatter = new SimpleDateFormat("HH:mm:ss");
            Date date = new Date();
